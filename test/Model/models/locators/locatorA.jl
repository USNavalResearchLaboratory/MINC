## UTIL FOR TESTS
struct LocatorATest{F <: Function, S <: String} <: TimeDefToVec
    getModel::F
    name::S
end
##
function LocatorATest()
    return LocatorATest(getLocatorA, "LocatorA")
end
##
function getLocatorA(; bs=1, kwargs...)
    ## Config
